...
- The model default is `gemini-3.1-flash-lite`. The configuration that passed the full real end-to-end run was `LLM_MODEL=gemini-3.6-flash` with `LLM_REASONING_EFFORT=low`. Do one full dry run with whichever you choose.
